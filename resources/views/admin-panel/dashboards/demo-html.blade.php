...
<p class='m-0'>            flex-direction: column;</p>
<p class='m-0'>            /* align-items: center; */</p>
<p class='m-0'>            padding: 55px 76px;</p>
<p class='m-0'>            gap: 45px;</p>
<p class='m-0'>        }</p>
...
<p class='m-0'>                                &lt;form @submit.prevent=&quot;onSubmit&quot; id=&quot;demo-form&quot; v-if=&quot;showForm&quot;&gt;</p>

<p class='m-0'>                                    &lt;div class=&quot;form-group d-flex flex-column&quot;&gt;</p>
<p class='m-0'>                                        &lt;label for=&quot;rating&quot; class=&quot;text-center mb-2&quot; id=&quot;form-label&quot;&gt;</p>
<p class='m-0'>                                            &lt;div v-if=&quot;!questions[rateAs_index].value&quot;&gt;</p>
<p class='m-0'>                                                @{{ questions[rateAs_index].text }}</p>
<p class='m-0'>                                            &lt;/div&gt;</p>
<p class='m-0'>                                        &lt;/label&gt;</p>

<p class='m-0'>                                        &lt;b-form-rating v-bind:id=&quot;questions[rateAs_index].question_id&quot; size=&quot;sm&quot; variant=&quot;warning&quot; color=&quot;#C2C2C2&quot; no-border v-model=&quot;questions[rateAs_index].value&quot; :max=&quot;5&quot; :inline=&quot;true&quot;&gt;</p>
<p class='m-0'>                                        &lt;/b-form-rating&gt;</p>

<p class='m-0'>                                    &lt;/div&gt;</p>

<p class='m-0'>                                    &lt;div v-if=&quot;(questions[rateAs_index].value &lt; 5) &amp;&amp; (questions[rateAs_index].value &gt; 0)&quot; style=&quot;</p>
<p class='m-0'>                                                                                                                                display: flex;</p>
<p class='m-0'>                                                                                                                                flex-direction: column;</p>
<p class='m-0'>                                                                                                                                padding: 0px;</p>
<p class='m-0'>                                                                                                                                gap: 20px;</p>
<p class='m-0'>                                                                                                                            &quot;&gt;</p>
<p class='m-0'>                                        &lt;div class=&quot;form-group d-flex flex-column&quot; v-for=&quot;(value, key) in questions&quot;&gt;</p>
<p class='m-0'>                                            &lt;div v-if=&quot;value.type === &#039;question&#039;&quot; id=&quot;form-question&quot;&gt;</p>
<p class='m-0'>                                                &lt;label id=&quot;label-massege&quot; for=&quot;message&quot;&gt;</p>
...
<p class='m-0'>                                &lt;div v-if=&quot;showFeedBeck&quot; style=&quot;</p>
<p class='m-0'>                                                                    width: 199px;</p>
<p class='m-0'>                                                                    height: 49px;</p>
<p class='m-0'>                                                                    font-family: &#039;Open Sans&#039;;</p>
<p class='m-0'>                                                                    font-style: normal;</p>
<p class='m-0'>                                                                    font-weight: 700;</p>
<p class='m-0'>                                                                    font-size: 36px;</p>
<p class='m-0'>                                                                    line-height: 49px;</p>
<p class='m-0'>                                                                    color: #000000;</p>
<p class='m-0'>                                                                    flex: none;</p>
<p class='m-0'>                                                                    order: 0;</p>
<p class='m-0'>                                                                    flex-grow: 0;</p>
<p class='m-0'>                                                                &quot;&gt;</p>
<p class='m-0'>                                    @{{ FeedBeckMassege }}</p>
<p class='m-0'>                                &lt;/div&gt;</p>
<p class='m-0'>                            &lt;/div&gt;</p>
<p class='m-0'>                        &lt;/div&gt;</p>
<p class='m-0'>                    &lt;/div&gt;</p>
...
<p class='m-0'>        const BASE_URL = &#039;{{ url('/api/surveys/') }}&#039; + &#039;/&#039;;</p>
<p class='m-0'>        var app = new Vue({</p>
<p class='m-0'>            el: &#039;#app&#039;,</p>
<p class='m-0'>            data: {</p>
<p class='m-0'>                showForm: true,</p>
<p class='m-0'>                showFeedBeck: false,</p>
<p class='m-0'>                FeedBeckMassege: &#039;&#039;,</p>
...
<p class='m-0'>                            console.log(response.data.text);</p>
<p class='m-0'>                            console.log(this.survey.feedback_request);</p>
<p class='m-0'>                            if ((this.questions[this.rateAs_index].value == 5) &amp;&amp; (response.data.redirect_url != null)) {</p>
<p class='m-0'>                                window.location.assign(response.data.redirect_url);</p>
<p class='m-0'>                            } else {</p>
<p class='m-0'>                                this.showForm = false;</p>
<p class='m-0'>                                this.showFeedBeck = true;</p>
<p class='m-0'>                                this.FeedBeckMassege = response.data.text;</p>
<p class='m-0'>                            }</p>
<p class='m-0'>                        })</p>
...
<p class='m-0'>                        vm.rateAs_index = vm.questions.findIndex(value =&gt; {</p>
